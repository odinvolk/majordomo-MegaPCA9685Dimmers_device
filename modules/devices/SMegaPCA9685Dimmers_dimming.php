...
file_get_contents("http://".$ipAddress."/".$Password."/?cmd=".$Port."e".$Ext.":v7");
$this->setProperty('Direction', "Down");
} else {
file_get_contents("http://".$ipAddress."/".$Password."/?cmd=".$Port."e".$Ext.":^7");
...
file_get_contents("http://".$ipAddress."/".$Password."/?cmd=".$Port.":x");
