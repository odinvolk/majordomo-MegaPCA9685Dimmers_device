...
if ($device_type == 'dimmerpca') {
 ...
 elseif (preg_match('/' . LANG_SMegaPCA9685Dimmers_PATTERN_BRIGHTNESS . '/uis', $command)) {
 ...
 elseif (preg_match('/' . LANG_SMegaPCA9685Dimmers_PATTERN_COLORTEMPERATURE . '/uis', $command)) {
  if(preg_match('/(?:\s)(\d{1,2}|100)(?:%|\s|$)/uis', $command, $matches)) {
